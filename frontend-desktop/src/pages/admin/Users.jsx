...
//           const tauxPaiement = () => {
//             const totalEngageUSD = data.usd?.total_engage || 0;
//             const totalPayeUSD = data.usd?.total_paye || 0;
//             const totalEngageCDF = data.cdf?.total_engage || 0;
//             const totalPayeCDF = data.cdf?.total_paye || 0;
            
//             const totalEngage = totalEngageUSD + (totalEngageCDF / 2500);
//             const totalPaye = totalPayeUSD + (totalPayeCDF / 2500);
            
//             return totalEngage > 0 ? (totalPaye / totalEngage) * 100 : 0;
//           }
...
//               terminees: terminees,
//               annulees: annulees,
//               montant_total_usd: data.usd?.total_engage || 0,
//               montant_total_cdf: data.cdf?.total_engage || 0,
//               montant_paye_usd: data.usd?.total_paye || 0,
//               montant_paye_cdf: data.cdf?.total_paye || 0,
...
//     const totalEngagementsUSD = stats.engagements.montant_total_usd + (stats.engagements.montant_total_cdf / tauxChange);
...
//         montant_usd: totalEngagementsUSD,
//         color: '#10B981'
//       },
//       { 
//         name: 'Dîmes', 
...
//           <div className="mb-4">
//             <p className="text-3xl font-bold text-gray-900">{stats.engagements.actives}</p>
//             <div className="mt-2">
//               <div className="text-lg font-semibold text-green-600"> {/* Changé de p à div */}
//                 {formatDoubleCurrency(stats.engagements.montant_total_usd, stats.engagements.montant_total_cdf)}
//               </div>
...
//                 {formatDoubleCurrency(stats.engagements.montant_paye_usd, stats.engagements.montant_paye_cdf)}
//               </span>
//             </div>
//             <div className="flex items-center justify-between">
...
//       {/* Section détails par devise */}
//       <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
//         <div className="flex items-center justify-between mb-6">
//           <div>
//             <h2 className="text-lg font-semibold text-gray-900">Détails par devise</h2>
//             <p className="text-sm text-gray-500">Répartition USD vs CDF</p>
//           </div>
...
//           {/* Engagements par devise */}
//           <div className="space-y-4">
//             <h3 className="font-semibold text-gray-700">Engagements</h3>
//             <div className="space-y-3">
//               <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
//                 <span className="text-gray-600">USD</span>
//                 <div className="text-right">
//                   <p className="font-bold text-green-700">{formatCurrency(stats.engagements.montant_total_usd, 'USD')}</p>
//                   <p className="text-xs text-gray-500">Payé: {formatCurrency(stats.engagements.montant_paye_usd, 'USD')}</p>
//                 </div>
//               </div>
//               <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
//                 <span className="text-gray-600">CDF</span>
//                 <div className="text-right">
//                   <p className="font-bold text-blue-700">{formatCurrency(stats.engagements.montant_total_cdf, 'CDF')}</p>
//                   <p className="text-xs text-gray-500">Payé: {formatCurrency(stats.engagements.montant_paye_cdf, 'CDF')}</p>
//                 </div>
//               </div>
//             </div>
//           </div>
